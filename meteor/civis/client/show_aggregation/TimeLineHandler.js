TimeLineHandler = function (containerSelector) {
...
TimeLineHandler.prototype.passable = function(nodeDataArray) {
    ...
    var svg = d3.select(this.containerSelector).append("svg").attr("width", this.getGraphWith())
...
TimeLineHandler.prototype.scalar = function(nodeDataArray) {
	...
	nodeDataArray = nodeDataArray.sort((a,b) => a.time - b.time);
